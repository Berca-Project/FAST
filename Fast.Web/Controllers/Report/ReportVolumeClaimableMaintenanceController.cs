...
{
    public class ReportVolumeClaimableMaintenanceController : BaseController<LPHModel>
    {
        ...
        public ReportVolumeClaimableMaintenanceController(
        ...
        public ActionResult GenerateExcel(DateTime dtFilter, long prodCenterID)
        {
            try
            {
                //byte[] excelData = ExcelGenerator.ExportVolumeClaimableMaintenance(AccountName);

                //Response.Clear();
                //Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                //Response.AddHeader("content-disposition", "attachment;filename=VolumeClaimableMaintenance.xlsx");
