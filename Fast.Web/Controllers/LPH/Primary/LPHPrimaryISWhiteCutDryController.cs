...
{
	[CustomAuthorize("primaryiswhitecutdry")]
	public class LPHPrimaryISWhiteCutDryController : BaseController<PPLPHModel>
	{
		...
		public LPHPrimaryISWhiteCutDryController(
		...
		// GET: LPHPrimaryISWhiteCutDryController
		public ActionResult Index(bool reset = false, bool restore = false)
		{
			...
			if (!reset)
			{
				...
				lphFilter.Add(new QueryFilter("MenuTitle", "LPHPrimaryISWhiteCutDryController"));
				...
				if (AccountProdCenterID == 4 || AccountProdCenterID == 5)
				{
					...
					queryAle = @"SELECT [EventDateTimeLocal],[EventType],[DataName],[Value] FROM [NpssReportBatchData]
                                WHERE EventID = (SELECT [BatchID] FROM [NpssReportBatch] WHERE BatchIdent='" + BatchID + @"' and starttimelocal >= starttimelocal - 100)and(
	                                EventType='Stem Cutting Drying' AND DataName in('Batch ID', 'Blend Code', 'WeighBelt810065.AverageTobacco','MoistMeter810067.MoistureMeter_Av','Cond810071.SteamFlow_Av','WeighBelt810065.TotWetTobacco','BedDryer810075.Z1_AirT_Av','BedDryer810075.Z2_AirT_Av','MoistMeter810076.MoistureMeter_Av','WeighBelt810085.TotWetTobacco')
		...
		// GET: LPHPrimaryISWhiteCutDryController/Details/5
		public ActionResult Details(int id)
		{
			return View();
		}

		// GET: LPHPrimaryISWhiteCutDryController/Create
		public ActionResult Create()
		{
			return View();
		}

		// POST: LPHPrimaryISWhiteCutDryController/Create
		[HttpPost]
		...
		// GET: LPHPrimaryISWhiteCutDryController/Edit/5
		...
		// POST: LPHPrimaryISWhiteCutDryController/Edit/5
		[HttpPost]
		...
		// GET: LPHPrimaryISWhiteCutDryController/Delete/5
		public ActionResult Delete(int id)
		{
			return View();
		}

		// POST: LPHPrimaryISWhiteCutDryController/Delete/5
		[HttpPost]
		...
		public ActionResult CheckPrev(long lphid = 0)
		{
			try
			{
				if (lphid != 0)
				{
					string submissions = _ppLphSubmissionsAppService.FindBy("LPHHeader", "LPHPrimaryISWhiteCutDryController", true); //ambil yang sudah submit saja
