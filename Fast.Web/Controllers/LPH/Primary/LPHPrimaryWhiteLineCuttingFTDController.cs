...
{
	[CustomAuthorize("primarywhitelinecuttingftd")]
	public class LPHPrimaryWhiteLineCuttingFTDController : BaseController<PPLPHModel>
	{
		...
		public LPHPrimaryWhiteLineCuttingFTDController(
		...
		// GET: LPHPrimaryWhiteLineCuttingFTDController
		public ActionResult Index(bool reset = false, bool restore = false)
		{
			...
			if (!reset)
			{
				...
				lphFilter.Add(new QueryFilter("MenuTitle", "LPHPrimaryWhiteLineCuttingFTDController"));
		...
		public ActionResult getPSSData(String BatchID)
		{
			try
			{
				...
				if (AccountProdCenterID == 4 || AccountProdCenterID == 5)
				{
					...
					//        " 'WeighBelt400.010.FlowAvg','WeighBelt400.010.TotalWetTob',"+
					//        " 'U02.FTDFlowSP.reAverageResPout','U02.FTDinletMoistDs.reAverageResPout','U02.FTDoutletMoistDs.reAverageResPout','U02.FTDwetQtyOnWeigherDs.reSumResPout',"+
					//        " 'U02.FTDprocRetGasPressureDs.reAverageResPout','U02.FTDprocGasTemperatureDs.reAverageResPout','U02.FTDprocCombFurnaceTempDs.reAverageResPout')"+
					...
					queryAle = @"SELECT [EventDateTimeLocal],CONCAT([Category],' ',[EventType]) as EventType,[DataName],[Value] FROM [NpssReportBatchData]
                        WHERE EventID = ( SELECT [BatchID] FROM [NpssReportBatch] WHERE BatchIdent ='" + BatchID + @"' and starttimelocal >= starttimelocal - 100)and(
	                        (EventType = 'Lamina FTD U02' and DataName in ('Blend','BatchID','Numeric Sap Batch ID',
	                        'WeighBelt400.010.FlowAvg','WeighBelt400.010.TotalWetTob',
	                        'U02.FTDFlowSP.reAverageResPout','U02.FTDinletMoistDs.reAverageResPout','U02.FTDoutletMoistDs.reAverageResPout','U02.FTDwetQtyOnWeigherDs.reSumResPout',
	                        'U02.FTDprocRetGasPressureDs.reAverageResPout','U02.FTDprocGasTemperatureDs.reAverageResPout','U02.FTDprocCombFurnaceTempDs.reAverageResPout'))
	                        or ( EventType = 'Lamina Cutting' and DataName in ('Report.WeighBelt400010.FlowAvg','Report.WeighBelt400010.TotalWetTob','Report.Cutter.BreakdownCount','Report.Cutter.WOCReport'))
                            or ( EventType = 'Lamina Cutting' and DataName in ('BatchID'))
		...
		// GET: LPHPrimaryWhiteLineCuttingFTDController/Details/5
		public ActionResult Details(int id)
		{
			return View();
		}

		// GET: LPHPrimaryWhiteLineCuttingFTDController/Create
		public ActionResult Create()
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineCuttingFTDController/Create
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineCuttingFTDController/Edit/5
		...
		// POST: LPHPrimaryWhiteLineCuttingFTDController/Edit/5
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineCuttingFTDController/Delete/5
		public ActionResult Delete(int id)
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineCuttingFTDController/Delete/5
		[HttpPost]
		...
		public ActionResult CheckPrev(long lphid = 0)
		{
			try
			{
				if (lphid != 0)
				{
					string submissions = _ppLphSubmissionsAppService.FindBy("LPHHeader", "LPHPrimaryWhiteLineCuttingFTDController", true); //ambil yang sudah submit saja
