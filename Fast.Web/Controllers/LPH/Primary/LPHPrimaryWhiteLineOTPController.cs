...
{
	[CustomAuthorize("primarywhitelineotp")]
	public class LPHPrimaryWhiteLineOTPController : BaseController<PPLPHModel>
	{
		...
		public LPHPrimaryWhiteLineOTPController(
		...
		// GET: LPHPrimaryWhiteLineOTPController
		public ActionResult Index(bool reset = false, bool restore = false)
		{
			...
			if (!reset)
			{
				...
				lphFilter.Add(new QueryFilter("MenuTitle", "LPHPrimaryWhiteLineOTPController"));
		...
		// GET: LPHPrimaryWhiteLineOTPController/Details/5
		public ActionResult Details(int id)
		{
			return View();
		}

		// GET: LPHPrimaryWhiteLineOTPController/Create
		public ActionResult Create()
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineOTPController/Create
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineOTPController/Edit/5
		...
		// POST: LPHPrimaryWhiteLineOTPController/Edit/5
		[HttpPost]
		...
		public ActionResult getPSSData(String BatchID)
		{
			try
			{
				...
				var queryAle = @"SELECT [EventDateTimeLocal],[EventType],[DataName],[Value]
                    ...
                    WHERE EventID = (SELECT [BatchID] FROM [NpssReportBatch] WHERE BatchIdent ='" + BatchID + @"' and starttimelocal >= starttimelocal - 100)and
                     ((EventType = 'END L100' and DataName in('Batch ID','PSS Batch Primary Key','L0101 Krosok Destination Silo','Solution BatchId'))or
                     (EventType = 'END L200' and DataName in('L0102 Lamina Destination Silo','L102_Cut Width Sample 1','L102_Cut Width Sample 2','L102_Cut Width Sample 3','L102_Cut Width Sample 4','L102_Cut Width Sample 5','L0102 Lamina Zone 04 ET Weigh Integration','L0102 Lamina Zone 04 CRES Weigh Integration','Solution BatchId')))
		...
		// GET: LPHPrimaryWhiteLineOTPController/Delete/5
		public ActionResult Delete(int id)
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineOTPController/Delete/5
		[HttpPost]
		...
		public ActionResult CheckPrev(long lphid = 0)
		{
			try
			{
				if (lphid != 0)
				{
					string submissions = _ppLphSubmissionsAppService.FindBy("LPHHeader", "LPHPrimaryWhiteLineOTPController", true); //ambil yang sudah submit saja
