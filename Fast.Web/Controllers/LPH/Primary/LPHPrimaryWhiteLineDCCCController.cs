...
{
	[CustomAuthorize("primarywhitelinedccc")]
	public class LPHPrimaryWhiteLineDCCCController : BaseController<PPLPHModel>
	{
		...
		public LPHPrimaryWhiteLineDCCCController(
		...
		// GET: LPHPrimaryWhiteLineDCCCController
		public ActionResult Index(bool reset = false, bool restore = false)
		{
			...
			if (!reset)
			{
				...
				lphFilter.Add(new QueryFilter("MenuTitle", "LPHPrimaryWhiteLineDCCCController"));
		...
		public ActionResult getPSSData(String BatchID)
		{
			try
			{
				...
				if (AccountProdCenterID == 4 || AccountProdCenterID == 5)
				{
					...
					//        " DataName in ('Blend','BatchID','Numeric Sap Batch ID',"+
					//        " '101 - Tobacco Type','101 - Report.DCC320.060.TotalWater','101 - Report.DCC320.060.AirTempAve','101 - Report.DCC320.060.TobTempAve','Burley.BSWeighBelt320.050.TotalWetTob','Burley.BSWeighBelt320.050.TotalDryTob','Burley.BSProdCode','Burley.BSPump360.020.SolutionBatchID1','Burley.BSPump360.020.SolutionTemp.Average','Burley.BSPump360.020.BSRatioAvg','Burley.BSPump360.020.TotalBS',"+
					//        " '102 - Tobacco Type','102 - Report.DCC320.060.TotalWater','102 - Report.DCC320.060.AirTempAve','102 - Report.DCC320.060.TobTempAve',"+
					//        " '103 - Tobacco Type','103 - Report.DCC320.060.TotalWater','103 - Report.DCC320.060.AirTempAve','103 - Report.DCC320.060.TobTempAve','Bright.BCWeighBelt320.050.TotalWetTob','Bright.BCWeighBelt320.050.TotalDryTob','Bright.BCProdCode','Bright.BCPump340.019.SolutionBatchID1','Bright.BCPump340.019.SolutionTemp.Average','Bright.BCPump340.019.BCRatioAvg','Bright.BCPump340.019.TotalBC',"+
					//        " '104 - Tobacco Type','104 - Report.DCC320.060.TotalWater','104 - Report.DCC320.060.AirTempAve','104 - Report.DCC320.060.TobTempAve',"+
					//        " '105 - Tobacco Type','105 - Report.DCC320.060.TotalWater','105 - Report.DCC320.060.AirTempAve','105 - Report.DCC320.060.TobTempAve')"+
					//        " ORDER BY EventType DESC";
					queryAle = @"SELECT [EventDateTimeLocal],CONCAT([Category],' ',[EventType]) as EventType,[DataName],[Value] FROM [NpssReportBatchData]
                        WHERE EventID=(SELECT[BatchID]FROM [NpssReportBatch] WHERE BatchIdent='" + BatchID + @"' and starttimelocal >= starttimelocal - 100)and(
	                        EventType = 'Lamina Infeed' and DataName in('Blend','BatchID','Numeric Sap Batch ID',
	                        '101 - Tobacco Type','101 - Report.DCC320.060.TotalWater','101 - Report.DCC320.060.AirTempAve','101 - Report.DCC320.060.TobTempAve','101 - Report.MoistureMeter340.013.MoistureAvg','Burley.BSWeighBelt320.050.TotalWetTob','Burley.BSWeighBelt320.050.TotalDryTob','Burley.BSProdCode','Burley.BSPump360.020.SolutionBatchID1','Burley.BSPump360.020.SolutionBatchID2','Burley.BSPump360.020.SolutionTemp.Average','Burley.BSPump360.020.BSRatioAvg','Burley.BSPump360.020.TotalBS',
                            '102 - Tobacco Type','102 - Report.DCC320.060.TotalWater','102 - Report.DCC320.060.AirTempAve','102 - Report.DCC320.060.TobTempAve','102 - Report.MoistureMeter340.013.MoistureAvg',
                            '103 - Tobacco Type','103 - Report.DCC320.060.TotalWater','103 - Report.DCC320.060.AirTempAve','103 - Report.DCC320.060.TobTempAve','103 - Report.MoistureMeter340.013.MoistureAvg','Bright.BCWeighBelt320.050.TotalWetTob','Bright.BCWeighBelt320.050.TotalDryTob','Bright.BCProdCode','Bright.BCPump340.019.SolutionBatchID1','Bright.BCPump340.019.SolutionBatchID2','Bright.BCPump340.019.SolutionTemp.Average','Bright.BCPump340.019.BCRatioAvg','Bright.BCPump340.019.TotalBC',
                            '104 - Tobacco Type','104 - Report.DCC320.060.TotalWater','104 - Report.DCC320.060.AirTempAve','104 - Report.DCC320.060.TobTempAve','104 - Report.MoistureMeter340.013.MoistureAvg',
                            '105 - Tobacco Type','105 - Report.DCC320.060.TotalWater','105 - Report.DCC320.060.AirTempAve','105 - Report.DCC320.060.TobTempAve','105 - Report.MoistureMeter340.013.MoistureAvg',
	                        'Report.TBSiloLoadSel1','Report.TBSiloLoadSel2','Bright.BCPump340.019.TotalBCSolution1','Bright.BCPump340.019.TotalBCSolution2','Burley.BSPump360.020.TotalBSSolution1','Burley.BSPump360.020.TotalBSSolution2')
				...
				var data = DataTableToJSONWithJavaScriptSerializer(dset.Tables[0], compoAndSAPDset?.Tables[0]);

				return Json(new { Status = "True", Data = data }, JsonRequestBehavior.AllowGet);
			}
			catch (Exception ex)
			{
				Helper.LogErrorMessage("Error PSS4 :" + ex.GetAllMessages(), Server.MapPath("~/Uploads/"));
				_logger.LogError(ex.GetAllMessages(), AccountID, AccountName);
				return Json(new { Status = "False" }, JsonRequestBehavior.AllowGet);
			}
		}
		public string DataTableToJSONWithJavaScriptSerializer(DataTable table, DataTable compoAndSAP)
		{
		...
		// GET: LPHPrimaryWhiteLineDCCCController/Details/5
		public ActionResult Details(int id)
		{
			return View();
		}

		// GET: LPHPrimaryWhiteLineDCCCController/Create
		public ActionResult Create()
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineDCCCController/Create
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineDCCCController/Edit/5
		...
		// POST: LPHPrimaryWhiteLineDCCCController/Edit/5
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineDCCCController/Delete/5
		public ActionResult Delete(int id)
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineDCCCController/Delete/5
		[HttpPost]
		...
		public ActionResult CheckPrev(long lphid = 0)
		{
			try
			{
				if (lphid != 0)
				{
					string submissions = _ppLphSubmissionsAppService.FindBy("LPHHeader", "LPHPrimaryWhiteLineDCCCController", true); //ambil yang sudah submit saja
