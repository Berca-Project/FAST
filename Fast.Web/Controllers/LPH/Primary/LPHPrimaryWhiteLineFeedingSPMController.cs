...
{
	[CustomAuthorize("primarywhitelinefeedingspm")]
	public class LPHPrimaryWhiteLineFeedingSPMController : BaseController<PPLPHModel>
	{
		...
		public LPHPrimaryWhiteLineFeedingSPMController(
		...
		// GET: LPHPrimaryWhiteLineFeedingSPMController
		public ActionResult Index(bool reset = false, bool restore = false)
		{
			...
			if (!reset)
			{
				...
				lphFilter.Add(new QueryFilter("MenuTitle", "LPHPrimaryWhiteLineFeedingSPMController"));
		...
		// GET: LPHPrimaryWhiteLineFeedingSPMController/Details/5
		public ActionResult Details(int id)
		{
			return View();
		}

		// GET: LPHPrimaryWhiteLineFeedingSPMController/Create
		public ActionResult Create()
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineFeedingSPMController/Create
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineFeedingSPMController/Edit/5
		...
		// POST: LPHPrimaryWhiteLineFeedingSPMController/Edit/5
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineFeedingSPMController/Delete/5
		public ActionResult Delete(int id)
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineFeedingSPMController/Delete/5
		[HttpPost]
		...
		public ActionResult CheckPrev(long lphid = 0)
		{
			try
			{
				if (lphid != 0)
				{
					string submissions = _ppLphSubmissionsAppService.FindBy("LPHHeader", "LPHPrimaryWhiteLineFeedingSPMController", true); //ambil yang sudah submit saja
