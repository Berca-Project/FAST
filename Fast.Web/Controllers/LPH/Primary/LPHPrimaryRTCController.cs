...
{
	[CustomAuthorize("primaryrtc")]
	public class LPHPrimaryRTCController : BaseController<PPLPHModel>
	{
		...
		public LPHPrimaryRTCController(
		...
		public ActionResult Index(bool reset = false, bool restore = false)
		{
			...
			string quantityEast = "0";
			string quantityWest = "0";
			string getIDReference = _referenceAppService.FindBy("Name", "QuantityRTC", true);
			...
			if (referenceList.Count > 0)
			{
				...
				if (cloveConList != null)
					foreach (var value in cloveConList.ToList())
					{
						...
						{
							case "West":
								quantityWest = value.Description;
								break;
							case "East":
								quantityEast = value.Description;
								break;
						}
					}
			}
			...
			{
				ViewBag.QuantityBox = quantityWest;
			}
			else
			{
				ViewBag.QuantityBox = quantityEast;
			}
			...
			if (!reset)
			{
				...
				lphFilter.Add(new QueryFilter("MenuTitle", "LPHPrimaryRTCController"));
		...
		// GET: LPHPrimaryRTCController/Details/5
		public ActionResult Details(int id)
		{
			return View();
		}

		// GET: LPHPrimaryRTCController/Create
		public ActionResult Create()
		{
			return View();
		}

		// POST: LPHPrimaryRTCController/Create
		[HttpPost]
		...
		// GET: LPHPrimaryRTCController/Edit/5
		...
		// POST: LPHPrimaryRTCController/Edit/5
		[HttpPost]
		...
		// GET: LPHPrimaryRTCController/Delete/5
		public ActionResult Delete(int id)
		{
			return View();
		}

		// POST: LPHPrimaryRTCController/Delete/5
		[HttpPost]
		...
		public ActionResult CheckPrev(long lphid = 0)
		{
			try
			{
				if (lphid != 0)
				{
					string submissions = _ppLphSubmissionsAppService.FindBy("LPHHeader", "LPHPrimaryRTCController", true); //ambil yang sudah submit saja
