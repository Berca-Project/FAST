...
{
	[CustomAuthorize("primaryiswhitefeeding")]
	public class LPHPrimaryISWhiteFeedingController : BaseController<PPLPHModel>
	{
		...
		public LPHPrimaryISWhiteFeedingController(
		...
		// GET: LPHPrimaryISWhiteFeedingController
		public ActionResult Index(bool reset = false, bool restore = false)
		{
			...
			if (!reset)
			{
				...
				lphFilter.Add(new QueryFilter("MenuTitle", "LPHPrimaryISWhiteFeedingController"));
				...
				if (AccountProdCenterID == 4 || AccountProdCenterID == 5)
				{
					...
					queryAle = @"SELECT [EventDateTimeLocal],[EventType],[DataName],[Value] FROM [NpssReportBatchData]
                                WHERE EventID = (SELECT [BatchID] FROM [NpssReportBatch] WHERE BatchIdent='" + BatchID + @"' and starttimelocal >= starttimelocal - 100)and(
	                                EventType='Stem Infeed' AND DataName in('Batch ID', 'Blend Code', 'Report.Component[1].WeighBelt800006.AverageTobacco','PSS Version','Report.Component[1].ExitDCC.MoistureAve','Infeed Operator','PSS Batch Primary Key (PK Batch)','Report.Component[1].ExitDCC.TemperatureAvg','Report.Component[1].WeighBelt800006.TotWetTobacco','Report.Component[1].CylTB_K800016.WaterQty')
		...
		// GET: LPHPrimaryISWhiteFeedingController/Details/5
		public ActionResult Details(int id)
		{
			return View();
		}

		// GET: LPHPrimaryISWhiteFeedingController/Create
		public ActionResult Create()
		{
			return View();
		}

		// POST: LPHPrimaryISWhiteFeedingController/Create
		[HttpPost]
		...
		// GET: LPHPrimaryISWhiteFeedingController/Edit/5
		...
		// POST: LPHPrimaryISWhiteFeedingController/Edit/5
		[HttpPost]
		...
		// GET: LPHPrimaryISWhiteFeedingController/Delete/5
		public ActionResult Delete(int id)
		{
			return View();
		}

		// POST: LPHPrimaryISWhiteFeedingController/Delete/5
		[HttpPost]
		...
		public ActionResult CheckPrev(long lphid = 0)
		{
			try
			{
				if (lphid != 0)
				{
					string submissions = _ppLphSubmissionsAppService.FindBy("LPHHeader", "LPHPrimaryISWhiteFeedingController", true); //ambil yang sudah submit saja
