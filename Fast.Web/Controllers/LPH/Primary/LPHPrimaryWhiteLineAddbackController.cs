...
{
	[CustomAuthorize("primarywhitelineaddback")]
	public class LPHPrimaryWhiteLineAddbackController : BaseController<PPLPHModel>
	{
		...
		public LPHPrimaryWhiteLineAddbackController(
		...
		// GET: LPHPrimaryWhiteLineAddbackController
		public ActionResult Index(bool reset = false, bool restore = false)
		{
			...
			if (!reset)
			{
				...
				lphFilter.Add(new QueryFilter("MenuTitle", "LPHPrimaryWhiteLineAddbackController"));
		...
		public ActionResult getPSSData(String BatchID)
		{
			try
			{
				...
				if (AccountProdCenterID == 4 || AccountProdCenterID == 5)
				{
					...
					//        " 'SLWB620.175TotWetTob','SLWB620.175TotDryTob','SLMM620.176Average','SLWB620.175AverageTob','SLProdCode1',"+
					//        " 'ISWB620.055TotWetTob','ISWB620.055TotDryTob','ISMM620.056Average','ISWB620.055AverageTob','ISProdCode1',"+
					//        " 'ETWB620.070TotWetTob','ETWB620.070TotDryTob','ETMM620.071Average','ETWB620.070AverageTob','ETProdCode1',"+
					//        " 'RSWB620.085TotWetTob','RSWB620.085TotDryTob','RSMM620.086Average','RSWB620.085AverageTob','RSProdCode1','RSProdCode2','RSProdCode3',"+
					//        " 'Total to Add Flavor','FlavourBatchID','FlavProdCode',"+
					//        " 'FinalWB625.055TotWetTob','FinalMM625.056Average')"+
					...
					queryAle = @"SELECT [EventDateTimeLocal],CONCAT([Category],' ',[EventType]) as EventType,[DataName],[Value] FROM [NpssReportBatchData]
                        WHERE EventID = ( SELECT [BatchID] FROM [NpssReportBatch] WHERE BatchIdent ='" + BatchID + @"' and starttimelocal >= starttimelocal - 100)and (
	                        EventType='Addback' and	DataName in ('Blend','BatchID','Numeric Sap Batch ID',
	                        'MasterWB620.150TotWetTob','MasterWB620.150TotDryTob','MasterMM620.151Average','MasterWB620.150AverageTob',
	                        'SLWB620.175TotWetTob','SLWB620.175TotDryTob','SLMM620.176Average','SLWB620.175AverageTob','SLProdCode1',
	                        'ISWB620.055TotWetTob','ISWB620.055TotDryTob','ISMM620.056Average','ISWB620.055AverageTob','ISProdCode1',
	                        'ETWB620.070TotWetTob','ETWB620.070TotDryTob','ETMM620.071Average','ETWB620.070AverageTob','ETProdCode1',
	                        ...
	                        'Total to Add Flavor','FlavourBatchID','FlavProdCode',
	                        'FinalWB625.055TotWetTob','FinalMM625.056Average'
							, 'ETSAPBatchIDSiloLinkup1'
							, 'ETSAPBatchIDSiloLinkup2'
							, 'ISSAPBatchIDSiloLinkup1'
							, 'ISSAPBatchIDSiloLinkup2'
							, 'FlavCyl625.020TotFlavQty1'
							, 'FlavourBatchID1'
							, 'FlavCyl625.020TotFlavQty2'
							, 'FlavourBatchID2'
							, 'RIFTABWB620.200TotWetTob'
							, 'RIFTABWB620.200TotDryTob'
							, 'RIFTABMM620.201Average'
							, 'RIFTABWB620.200AverageTob'
							, 'RIFTABProdCode1'
							, 'RIFTABSAPBatchIDSiloLinkup1'
							, 'RIFTABSAPBatchIDSiloLinkup2'
							)
	                        or DataName in ('Report.CFSiloLoadSel','ISSAPBatchIDSiloLinkup1')
		...
		// GET: LPHPrimaryWhiteLineAddbackController/Details/5
		public ActionResult Details(int id)
		{
			return View();
		}

		// GET: LPHPrimaryWhiteLineAddbackController/Create
		public ActionResult Create()
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineAddbackController/Create
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineAddbackController/Edit/5
		...
		// POST: LPHPrimaryWhiteLineAddbackController/Edit/5
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineAddbackController/Delete/5
		public ActionResult Delete(int id)
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineAddbackController/Delete/5
		[HttpPost]
		...
		public ActionResult CheckPrev(long lphid = 0)
		{
			try
			{
				if (lphid != 0)
				{
					string submissions = _ppLphSubmissionsAppService.FindBy("LPHHeader", "LPHPrimaryWhiteLineAddbackController", true); //ambil yang sudah submit saja
