...
{
	[CustomAuthorize("primarywhitelinefeedingwhite")]
	public class LPHPrimaryWhiteLineFeedingWhiteController : BaseController<PPLPHModel>
	{
		...
		public LPHPrimaryWhiteLineFeedingWhiteController(
		...
		// GET: LPHPrimaryWhiteLineFeedingWhiteController
		public ActionResult Index(bool reset = false, bool restore = false)
		{
			...
			if (!reset)
			{
				...
				lphFilter.Add(new QueryFilter("MenuTitle", "LPHPrimaryWhiteLineFeedingWhiteController"));
		...
		public ActionResult getPSSData(String BatchID)
		{
			try
			{
				...
				if (AccountProdCenterID == 4 || AccountProdCenterID == 5)
				{
					...
					//        " DataName in ('Blend','BatchID','Numeric Sap Batch ID','Composition Version',"+
					//        " '101 - Number of Slices','102 - Number of Slices','103 - Number of Slices',"+
					//        " '101 - Report.WeighBelt320.050.TotalWetTob','102 - Report.WeighBelt320.050.TotalWetTob','103 - Report.WeighBelt320.050.TotalWetTob')"+
					...
					queryAle = @"SELECT [EventDateTimeLocal],CONCAT([Category],' ',[EventType]) as EventType,[DataName],[Value] FROM [NpssReportBatchData]
                                WHERE EventID = ( SELECT [BatchID] FROM [NpssReportBatch] WHERE BatchIdent ='" + BatchID + @"' and starttimelocal >= starttimelocal - 100)and(
	                                EventType='Lamina Infeed' and DataName in ('Blend','BatchID','Numeric Sap Batch ID','Composition Version',
                                '101 - Number of Slices','102 - Number of Slices','103 - Number of Slices',
                                '101 - Report.WeighBelt320.050.TotalWetTob','102 - Report.WeighBelt320.050.TotalWetTob','103 - Report.WeighBelt320.050.TotalWetTob'))
		...
		// GET: LPHPrimaryWhiteLineFeedingWhiteController/Details/5
		public ActionResult Details(int id)
		{
			return View();
		}

		// GET: LPHPrimaryWhiteLineFeedingWhiteController/Create
		public ActionResult Create()
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineFeedingWhiteController/Create
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineFeedingWhiteController/Edit/5
		...
		// POST: LPHPrimaryWhiteLineFeedingWhiteController/Edit/5
		[HttpPost]
		...
		// GET: LPHPrimaryWhiteLineFeedingWhiteController/Delete/5
		public ActionResult Delete(int id)
		{
			return View();
		}

		// POST: LPHPrimaryWhiteLineFeedingWhiteController/Delete/5
		[HttpPost]
		...
		public ActionResult CheckPrev(long lphid = 0)
		{
			try
			{
				if (lphid != 0)
				{
					string submissions = _ppLphSubmissionsAppService.FindBy("LPHHeader", "LPHPrimaryWhiteLineFeedingWhiteController", true); //ambil yang sudah submit saja
