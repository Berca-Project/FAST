...
{
	[CustomAuthorize("mentholator")]

	public class MentholatorController : BaseController<LPHModel>
	{
		#region ::Services::
		...
		public ActionResult Index(bool reset = false)
		{
			...
			LoadLPHHeader(model, _locationAppService, _employeeAppService, _userAppService, _userRoleAppService, _machineAppService, _brandAppService, _jobTitleAppService, _wppAppService, null, 7);
		...
		public ActionResult Edit(long lphid)
		{
			...
			LoadLPHHeader(model2, _locationAppService, _employeeAppService, _userAppService, _userRoleAppService, _machineAppService, _brandAppService, _jobTitleAppService, _wppAppService, null, 7);
		...
		public ActionResult Approval(long lphid)
		{
            ...
            LoadLPHHeaderApproval(model2, _locationAppService, _employeeAppService, _userAppService, _userRoleAppService, _machineAppService, _brandAppService, _jobTitleAppService, _wppAppService, null, 7, model.LPH.LocationID);
            refGroup(_referenceAppService, _referenceDetailAppService);
            return View(model);
		}
		...
		[HttpPost]
		public async Task<ActionResult> Revise(long id, string comment)
		{
			try
			{
				await RejectLPH(
		...
		public ActionResult CheckPrev(long lphid = 0, string machine = "")
		{
			try
			{
				if (lphid != 0)
				{
					string submissions = _lphSubmissionsAppService.FindBy("LPHHeader", "MentholatorController", true); //ambil yang sudah submit saja
		...
		public ActionResult Submitted(long lphid, int type = 0)
		{
			...
			ViewBag.PageHeader = "LPH Mentholator";
			if (type == 1)
				ViewBag.PageHeader = "LPH Mentholator <span class='tx-success'>(Previous Submit)</span>";
			...
			LoadLPHHeader(model2, _locationAppService, _employeeAppService, _userAppService, _userRoleAppService, _machineAppService, _brandAppService, _jobTitleAppService, _wppAppService, null, 7, model.LPH.LocationID);
		...
		private LPHModel GetLPH(long id)
		{
			...
			LPHModel ppLphModel = data.DeserializeToLPH();
