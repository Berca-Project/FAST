...
namespace Fast.Web.Utils
{
	public class TelnetHelper
	{
        ...
        private string strResultLog = "";

        public TelnetHelper(string Address, int Port, int CommandTimeout)
		{
			address = Address;
			port = Port;
		...
		public bool Connect()
		{
			...
			try
			{
                ...
                strResultLog += "All is good";
                // All is good
                return true;
			}
			catch (Exception eeeee)
			{
                strResultLog += "Error exception message: " + eeeee.Message;
